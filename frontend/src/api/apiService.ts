...
export async function getCameraByID(id: number) {
  const response = await axios.get(`${CAMERAS_URL}/${id}/`, {
    withCredentials: true,
  });
  if (response.status !== 200) {
...
export async function createCamera(camera: Camera) {
  const response = await axios.post(`${CAMERAS_URL}`, camera, {
    withCredentials: true,
  });
...
export async function updateCamera(camera: Camera) {
  ...
  const response = await axios.put(`${CAMERAS_URL}${camera.id}/`, camera, {
    withCredentials: true,
  });
  if (response.status !== 200) {
...
export async function deleteCamera(camera: Camera) {
  ...
  const response = await axios.delete(`${CAMERAS_URL}${camera.id}/`, {
    withCredentials: true,
  });
...
export async function createParkingSpot(spot: ParkingSpot) {
  const response = await axios.post(`${PARKING_SPOTS_URL}/`, spot, {
    withCredentials: true,
  });
  if (response.status !== 201) {
...
export async function updateParkingSpot(spot: ParkingSpot) {
  ...
  const response = await axios.put(`${PARKING_SPOTS_URL}/${spot.id}/`, spot, {
    withCredentials: true,
  });
  if (response.status !== 200) {
...
export async function deleteParkingSpot(spot: ParkingSpot) {
  ...
  const response = await axios.delete(`${PARKING_SPOTS_URL}/${spot.id}/`, {
    withCredentials: true,
  });
  if (response.status !== 204) {
...
export async function createVertex(vertex: Vertex) {
  const response = await axios.post(`${VERTICES_URL}`, vertex, {
    withCredentials: true,
  });
  if (response.status !== 201) {
...
export async function updateVertex(vertex: Vertex) {
  ...
  const response = await axios.put(`${VERTICES_URL}/${vertex.id}/`, vertex, {
    withCredentials: true,
  });
  if (response.status !== 200) {
...
export async function deleteVertex(vertex: Vertex) {
  ...
  const response = await axios.delete(`${VERTICES_URL}/${vertex.id}/`, {
    withCredentials: true,
  });
  if (response.status !== 204) {
